...
public class DataPemerintahanActivity extends AppCompatActivity {

    private Spinner spinnerTabel, spinnerTahun;
    private WebView webView;
    private String selectedTableId = ""; // For storing nmtbl

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_datapemerintah);
        ...
        if(isConnected()) {
            ...
            Intent intent = new Intent(DataPemerintahanActivity.this, NetworkCheckActivity.class);
            intent.putExtra("origin", "DataPemerintahanActivity");
    ...
    private void setupTableSpinner() {
        ...
        String query = "SELECT judultbl, nmtbl FROM 0004_judul WHERE jnstbl = '3'";
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<>(DataPemerintahanActivity.this, android.R.layout.simple_spinner_item, tables);
                    ...
                    spinnerTabel.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                            selectedTableId = tableIds.get(position); // Store nmtbl value
                            if(isConnected()) {
                                loadData();
                            }else {
                                Intent intent = new Intent(DataPemerintahanActivity.this, NetworkCheckActivity.class);
                    ...
                    Toast.makeText(DataPemerintahanActivity.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<String> call, Throwable t) {
                Toast.makeText(DataPemerintahanActivity.this, "Network error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setupYearSpinner() {
        Retrofit retrofit = ApiClient.getRetrofitInstance();
        Api api = retrofit.create(Api.class);
        String query = "SELECT tahun FROM 0005_tahun WHERE pem=1";
        String key = "trengginas";
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<>(DataPemerintahanActivity.this, android.R.layout.simple_spinner_item, years);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private void fetchIconUrl() {
        Retrofit retrofit = ApiClient.getRetrofitInstance();
        Api api = retrofit.create(Api.class);
        String query = "SELECT REPLACE(icon, 'jokosanbps', 'bpstrenggalek') FROM 0007_list_datatabel WHERE id=2";
        String key = "trengginas";
    ...
    private void loadData() {
        ...
        String url = "https://bpstrenggalek.com/trengginas/02_pemerintahan.php?jdl=" + selectedTableId + "&th=" + selectedYear;
        if(isConnected()){
            webView.loadUrl(url);
        } else {
            Intent intent = new Intent(DataPemerintahanActivity.this, NetworkCheckActivity.class);
    ...
    private void showToast(String message) {
        Toast.makeText(DataPemerintahanActivity.this, message, Toast.LENGTH_SHORT).show();
    }
}
