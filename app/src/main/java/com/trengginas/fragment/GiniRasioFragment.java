...
public class GiniRasioFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_gini_rasio, container, false);
    ...
    private void loadTahunData() {
        ...
        Call<String> call = api.getTahunList("trengginas", "SELECT tahun FROM 0005_tahun WHERE gini=1");
    ...
    private void loadWebViewContent() {
        ...
        String url = "https://bpstrenggalek.com/trengginas/03_ginirasio.php?th=" + selectedTahun;
        currentUrl = url;
        webView.loadUrl(url);
    }
}
