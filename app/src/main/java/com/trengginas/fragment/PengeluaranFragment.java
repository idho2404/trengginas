...
public class PengeluaranFragment extends Fragment {
    ...
    private CustomWebView webView;  // Use CustomWebView instead of WebView
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        webView = view.findViewById(R.id.web_view);  // CustomWebView instance
        if(isConnected()) {
            setupJudulSpinner();
            setupTahunSpinner();
            setupWebView();
            ...
            intent.putExtra("origin", "PengeluaranFragment");
