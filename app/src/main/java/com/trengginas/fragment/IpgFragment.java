...
public class IpgFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_ipg, container, false);
        ...
        if(isConnected()) {
            ...
            intent.putExtra("origin", "IpgFragment");
    ...
    private void loadWebViewContent() {
        ...
        String url = "https://bpstrenggalek.com/trengginas/03_ipg.php?th=" + selectedTahun;
        webView.loadUrl(url);
    }
}
